...
public class PhotoAdapter extends RecyclerView.Adapter<com.cs.news1.fragment.fm_adapter.PhotoAdater.PhotoViewholder> {
    ...
    @Override
    public com.cs.news1.fragment.fm_adapter.PhotoAdater.PhotoViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View root = LayoutInflater.from(context).inflate(R.layout.item_photo, parent, false);
        return new com.cs.news1.fragment.fm_adapter.PhotoAdater.PhotoViewholder(root);
